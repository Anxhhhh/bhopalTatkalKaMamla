  ...
  return (
    <div className="bg-background text-on-background min-h-screen overflow-x-hidden font-body-lg">
      ...
      {currentView === 'landing' && (
        <>
          {/* Top Navbar */}
          <nav className="hidden md:flex fixed top-0 w-full z-50 justify-between items-center px-gutter h-16 bg-surface/70 backdrop-blur-xl border-b border-outline-variant/30">
            <div className="flex items-center gap-8">
              <div className="font-display-lg text-primary tracking-tighter text-2xl font-bold">Bhopal Tatkal Mamla</div>
              <div className="flex gap-6">
                <button 
                  onClick={triggerLaunchSequence}
                  className="text-on-surface-variant font-medium hover:text-primary-container transition-colors scale-95 duration-150 text-body-lg"
                >
                  Dashboard
                </button>
                <a className="text-on-surface-variant font-medium hover:text-primary-container transition-colors scale-95 duration-150 text-body-lg" href="#features">City Map</a>
                <a className="text-on-surface-variant font-medium hover:text-primary-container transition-colors scale-95 duration-150 text-body-lg" href="#routing">Routes</a>
                <a className="text-on-surface-variant font-medium hover:text-primary-container transition-colors scale-95 duration-150 text-body-lg" href="#sequence">Analytics</a>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <button 
                onClick={() => alert("Simulation alerts are operational.")} 
                className="text-on-surface-variant hover:text-primary-container transition-colors relative"
              >
              ...
              <button 
                onClick={triggerLaunchSequence}
                className="bg-primary-container text-on-primary-container px-4 py-2 rounded font-body-sm font-semibold hover:bg-primary transition-colors cursor-pointer"
              >
                Launch App
              </button>
            </div>
          ...
          <nav className="md:hidden fixed top-0 w-full z-50 flex justify-between items-center px-margin-mobile h-16 bg-surface/90 backdrop-blur-md border-b border-outline-variant/30">
            ...
            <button 
              onClick={triggerLaunchSequence}
              className="bg-primary-container text-on-primary-container px-3 py-1.5 rounded font-body-sm font-semibold"
            >
              Launch
            </button>
          </nav>
          ...
          {/* Footer */}
          <footer className="border-t border-outline-variant/20 bg-surface-container-lowest py-8 text-center">
            <div className="font-display-lg text-primary tracking-tighter text-xl font-bold mb-2">Bhopal Tatkal Mamla</div>
            <p className="font-body-sm text-body-sm text-on-surface-variant">© 2026 Urban Monitoring Core. Sector 7 Administration.</p>
          </footer>
        </>
      )}
